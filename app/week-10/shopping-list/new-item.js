...
export default function NewItem({itemListSetter}){
    ...
    function handleSubmit(event){
        ...
        dbAddItem(user.uid, item).then(() => {
            itemListSetter((prevItems) => [...prevItems, item]); 
        });
    ...
    return(
        <div>
            <h2 className="ml-5 mt-3 text-xl  text-rose-900">Add a new item!</h2>
